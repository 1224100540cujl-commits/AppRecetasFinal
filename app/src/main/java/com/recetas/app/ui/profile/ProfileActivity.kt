...
import com.recetas.app.ui.notifications.NotificationsActivity
import com.recetas.app.ui.tags.TagsActivity
...
class ProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.collectionsCard.setOnClickListener {
            startActivity(Intent(this, com.recetas.app.ui.collections.CollectionsActivity::class.java))
        }
